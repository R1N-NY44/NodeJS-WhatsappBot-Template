    ...
    try {
        ...
        if (fs.existsSync(animationFolder)) {
            ...
            if (animFiles.length > 0) {
                await chat.sendMessage(`✨ Stiker animasi (APNG) ditemukan: ${animFiles.length} stiker...`);
                ...
                for (const file of animFiles) {
                    ...
                    try {
                        ...
                        execSync(`ffmpeg -y -i "${inputPath}" -movflags faststart -pix_fmt yuv420p -vf "scale=512:-1:flags=lanczos" "${outputPath}"`);
                        ...
                        await chat.sendMessage(media, {
                            ...
                            stickerName: `LINE ID ${id} (APNG-MP4)`,
                ...
                return await chat.sendMessage("✅ Semua stiker animasi telah dikirim dalam format video.");
            }
        }
